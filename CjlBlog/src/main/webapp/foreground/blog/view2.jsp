...
<div style="background-color:#fff;width:68%;float:left;">
<div class="infosbox"><!--  data_list -->
	<div>
...
<div class="data_list" >
	...
	<div class="publish_comment">
			...
			<img onclick="javascript:loadimage();"   title="换一张试试" name="randImage" id="randImage" src="${pageContext.request.contextPath}/image.jsp" width="60" height="20" border="1" align="middle">
