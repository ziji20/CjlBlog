...
jQuery(document).ready(function ($) {
    $("#spig").mousedown(function (e) {
        if(e.which==3){
        showMessage("秘密通道:<br />   <a href=\"/index.html\" title=\"首页\">首页</a>	<a href=\"/login.jsp\" title=\"登陆\">博主登陆</a>",10000);
}
});
...
jQuery(document).ready(function ($) {
    ...
    $('#blog_content').mouseover(function(){
        showMessage('点击查看!');
    });
});
...
jQuery(document).ready(function ($) {
    ...
    window.setInterval(function () {
        msgs = ["播报明日天气<iframe name=\"xidie\" src=\"http://www.weather.com.cn/data/sk/101190408.html\"frameborder=\“0\” scrolling=\"no\" height=\"15px\"  width=\"130px\" allowtransparency=\"true\" ></iframe>", "陪我聊天吧！", "<a href=\"http://messense.me/feed/\" target=\"_blank\" rel=\"external\" tip=\"Feed\"><img border=\"0\" title=\"订阅乱了感觉\" alt=\"Feed\" src=\"${pageContext.request.contextPath}/static/images/logo.png\"></a>", "好无聊哦，你都不陪我玩！", "…@……!………", "^%#&*!@*(&#)(!)(", "我可爱吧！嘻嘻!~^_^!~~","谁淫荡呀?~谁淫荡?，你淫荡呀!~~你淫荡！~~","从前有座山，山上有座庙，庙里有个老和尚给小和尚讲故事，讲：“从前有座……”"];
        var i = Math.floor(Math.random() * msgs.length);
...
jQuery(document).ready(function ($) {
    window.setInterval(function () {
        msgs = ["播报明日天气<iframe name=\"xidie\" src=\"http://www.weather.com.cn/data/sk/101190408.html\"frameborder=\“0\” scrolling=\"no\" height=\"15px\"  width=\"130px\" allowtransparency=\"true\" ></iframe>", "快快订阅我的博客吧！<a href=\"http://ziji.com/\" target=\"_blank\" rel=\"external\" tip=\"Feed\"><img border=\"0\" title=\"订阅乱了感觉\" alt=\"Feed\" src=\"${pageContext.request.contextPath}/static/images/logo.png\"></a>", "乾坤大挪移！", "我飘过来了！~", "我飘过去了", "我得意地飘！~飘！~"];
        var i = Math.floor(Math.random() * msgs.length);
...
jQuery(document).ready(function ($) {
    ...
    $("#contactInformation").click(function () {
        showMessage("留下你的联系方式 ，不然就是无头像人士了！");
        $(".spig").animate({
            top: $("#contactInformation").offset().top - 70,
            left: $("#contactInformation").offset().left - 170
        },
		{
		    queue: false,
		    duration: 1000
    ...
    $("#content").click(function () {
        showMessage("认真填写哦！不然会被认作垃圾的哦！我的乖乖~");
        $(".spig").animate({
            top: $("#content").offset().top - 70,
            left: $("#content").offset().left - 170
        },
		{
		    queue: false,
		    duration: 1000
